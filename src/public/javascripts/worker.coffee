  ...
  run: () ->
    stateMapper(status) ->
      ...
      switch status
        ...
        when "DOWNLOADING_MAPPING_DATA" then(
        str = "Downloading Mapping Data, To Make Some Checkbooks Fatta")
        when "DOWNLOADING_MAPPING_CODE" then(
